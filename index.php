...
class post_card_creation
{
    ...
    function check_if_promo($post_id)
    {
        include('include/connection.php');
        $sql = "SELECT * FROM `promoted` WHERE post_id = '$post_id'";
    ...
    function generate_card_promo($htype, $ulogid)
    {
        $class_logid = $ulogid;
        ...
        while ($class_row = mysqli_fetch_assoc($res)) {
            ...
            if ($this->check_if_promo($class_row['id'])) {
                $shared = false;
...
<body>
                ...
                <div style="margin-top: 3%;">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li style="display:<?= $adminship_menu ?>;"><a class="dropdown-item" href="admin/admin.php">Admin Dashboard - Old</a></li>
                            ...
                            <li style="display:<?= $adminship_menu ?>;"><a class="dropdown-item" href="admin_dashboard/index.php">Admin Dashboard - New</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="row" style="background-color:aliceblue; width: 99.9%;">
        ...
        <div class="col-sm-3 home1 hide-in-mobile" style="overflow-y:scroll;" id="home1">
            ...
            $gen_post_list->generate_card_promo($home_type, $ulogid);
            ?>
        </div>
