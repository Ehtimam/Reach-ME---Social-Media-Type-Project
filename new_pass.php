...
<head>
    ...
    <title> New Password - ReachMe </title>
...
<body style="text-align: center;">
    ...
    <div class="reg">
        <h3> Welcome </h3>
        <form name="myform" align="center" method="POST" action='subdir/verification.php' onsubmit="return checkForm()">


            <input type="text" name="code" placeholder="Confirmation code" id="code">

            
            <input type="password" name="npass" placeholder="New Password" id="password" >
    ...
    <script>
        function checkForm() {
            ...
            let m = document.forms["myform"]["password"].value;

            let n = document.forms["myform"]["cpass"].value;
            ...
            if (x == "") {
                ...
                alert("Your password didn't confirm");
                return false;
            }
            return true;
        }
