        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="myTab" style="margin: 2%; text-align:center;">
                    <h3>Create New Alert or Seek for Blood Donation</h3>
                </div>
            </div>
            <!--Home Nevigation End-->
    ...
    <div class="row" style="background-color:aliceblue; width: 99.9%;">
        ...
        <div class="col-sm-8" style="overflow-y:scroll;" id="home2">
            ...
            <div class="card-main">
                ...
                <form class="create-post-form" action="subdir/post_now_alert.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-4" style="float:left;">
                                ...
                                <script>
                                    $('.type').change(function() {
                                        ...
                                        if (responseID == "alert" || responseID == "blood") {
