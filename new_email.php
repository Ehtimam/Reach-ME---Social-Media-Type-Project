...
<body style="text-align: center;">
    ...
    <div class="reg">
        <h3> Welcome </h3>
        <form name="myform" align="center" method="POST" action='subdir/verify_ch_email.php' onsubmit="return checkForm()">


            <input type="text" name="code" placeholder="Confirmation code" id="code">
            
            <input type="email" name="nemail" placeholder="New Email" id="password">
    ...
    <script>
        function checkForm() {
            ...
            if (x == "") {
                ...
                alert("Please Enter New your new Email!");
                return false;
            }
            return true;
        }
